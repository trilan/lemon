...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages_page', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages_page_set', null=True, to=orm['auth.User'])),
    ...
    models = {
        ...
        'pages.page': {
            'Meta': {'ordering': "['url_path']", 'object_name': 'Page'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages_page_set'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'publication_start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
